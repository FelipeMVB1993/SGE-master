...
//       }
//       await carregaAlunos(); // Atualiza a tabela após adicionar ou editar
//       setSelectedAluno(null); // Limpa o aluno selecionado após a edição
//     } catch (error) {
...
//           <ComponenteFormularioAluno selectedAluno={selectedAluno} onSave={handleSave} ></ComponenteFormularioAluno>
//           <div className="row">
//                     <div className="col-6">
...
//                                 <input type="text" class="form-control" placeholder="Informe o CPF do Aluno" aria-label="Username" aria-describedby="addon-wrapping" />
//                             </div>
//                         </div>
//                     </div>
//                     <div id='pesquisar'>
